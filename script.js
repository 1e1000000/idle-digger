...
const factoryUpgradeInitCost = [null,new Decimal(1),new Decimal(6),new Decimal(2000),new Decimal(6.4),new Decimal(45),new Decimal(9000),new Decimal(640),new Decimal(1800),new Decimal(Infinity)] // Infinity mean not completed yet
