game = {
  ...
  factoryUpgrade: [null, new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0)],
  lastTick: Date.now(),
...
const factoryUpgradeInitCost = [null,new Decimal(1),new Decimal(6),new Decimal(Infinity),new Decimal(6.4),new Decimal(45),new Decimal(Infinity)] // Infinity mean not completed yet
