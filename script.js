game = {
  ...
  factoryUpgrade: [null, new Decimal(0), new Decimal(0)],
  lastTick: Date.now(),
...
function loop(unadjusted, off = 0) { //the begin of gameloop
  ...
  document.getElementById("factoryUpgrade2").style.display = (game.factoryUpgrade[0].gte(2.999) ? "inline-block" : "none")
  // update texts
